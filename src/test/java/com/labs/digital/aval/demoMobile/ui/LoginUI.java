...
public class LoginUI {
    ...
    public static final Target TITLEDASH = Target.the(" login button main ").located(By.id("com.saucelabs.mydemoapp.android:id/mTvTitle"));
    public static final Target MENU = Target.the("menu").located(By.id("com.saucelabs.mydemoapp.android:id/menuIV"));
   // public static final Target BUTTON_VIRTUAL = Target.the("boton login ").located(By.xpath("//android.widget.TextView[@resource-id='com.saucelabs.mydemoapp.android:id/itemTV' and @text='Log In']"));
